      ...
      <div className="relative w-full max-w-lg bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl overflow-hidden text-slate-200">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-950">
            <div>
              <h3 className="font-bold text-white text-base truncate max-w-sm">{title}</h3>
              <p className="text-xs text-slate-400">Prospect Progress, Notes & Estimated Deal Value</p>
            </div>
            <button
              type="button"
              onClick={onClose}
