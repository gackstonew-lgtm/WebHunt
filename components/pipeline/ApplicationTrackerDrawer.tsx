...
export default function ApplicationTrackerDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl bg-[#0D0D0D] border-l border-[rgba(228,222,210,0.2)] text-[#F6F4F1] h-full flex flex-col shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[rgba(228,222,210,0.12)] bg-[#080808]">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-bold text-[#F6F4F1] text-base truncate max-w-xs sm:max-w-md">
                {job.title}
              </h3>
              <p className="text-xs text-[#A8A196]">
                Application Tracking for <span className="text-[#F6F4F1] font-semibold">{job.company}</span>
              </p>
            </div>
          </div>
          <button
        ...
        {/* Content */}
        <div className="p-6 overflow-y-auto space-y-6 text-xs text-[#F6F4F1] flex-1">
          {/* Quick Apply Action Strip */}
          <div className="p-4 rounded-2xl bg-[#080808] border border-[rgba(228,222,210,0.12)] space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <select
                ...
                className="bg-[#161616] border border-[rgba(249,92,75,0.4)] text-xs text-[#F6F4F1] px-3 py-1.5 rounded-xl font-semibold focus:outline-none cursor-pointer"
              >
            ...
            <div className="pt-2 border-t border-[rgba(228,222,210,0.08)] flex items-center justify-between">
              <span className="text-[11px] text-[#A8A196]">Original Listing on {job.source}</span>
              <a
                href={job.url}
                target="_blank"
                rel="noopener noreferrer"
                className="px-3.5 py-1.5 rounded-xl bg-[#F95C4B] hover:bg-[#E04838] text-white font-semibold text-xs shadow-md shadow-[#F95C4B]/20 flex items-center space-x-1.5 transition"
              >
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 bg-[#080808] p-3.5 rounded-2xl border border-[rgba(228,222,210,0.12)]">
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <span className={isChecked ? "text-[#F6F4F1] font-medium" : "text-[#A8A196]"}>
                      {item.label}
                    </span>
                  </button>
                );
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-[#080808] p-3.5 rounded-2xl border border-[rgba(228,222,210,0.12)]">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-xl bg-[#161616] border border-[rgba(228,222,210,0.12)] text-xs text-[#F6F4F1]"
                />
              </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 rounded-2xl bg-[#080808] border border-[rgba(228,222,210,0.12)] focus:outline-none focus:ring-1 focus:ring-[#F95C4B] text-xs text-[#F6F4F1] leading-relaxed"
            />
          </div>
        </div>
