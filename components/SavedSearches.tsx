...
export default function SavedSearches() {
  ...
  return (
    <div className="space-y-4">
      <div className="bg-[#0D0D0D] border border-[rgba(228,222,210,0.12)] rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xl">
        ...
        <div className="flex items-center space-x-3">
          ...
          {history.length > 0 && (
            <button
              onClick={handleClear}
              className="text-xs text-[#A8A196] hover:text-[#F95C4B] transition"
            >
              Clear
            </button>
          )}
      ...
      {history.length === 0 ? (
        <div className="p-12 text-center rounded-3xl bg-[#0D0D0D] border border-[rgba(228,222,210,0.12)] space-y-3">
          <div className="w-12 h-12 rounded-2xl bg-[#080808] flex items-center justify-center text-[#A8A196] mx-auto border border-[rgba(228,222,210,0.08)]">
            <History className="w-6 h-6 text-[#F95C4B]" />
          </div>
          <h4 className="text-base font-bold text-[#F6F4F1]">No Search Scans Recorded Yet</h4>
          ...
          <div className="pt-2">
            <Link
              href="/"
              className="inline-flex items-center space-x-2 px-4 py-2 rounded-xl bg-[#F95C4B] hover:bg-[#E04838] text-white text-xs font-bold shadow-md shadow-[#F95C4B]/20 transition"
            >
